...
class SuperAdmin extends Component {
    ...
    constructor(props){
      ...
      //getting unpaid  invoices from back-end.
        componentDidMount(){
            axios.get('https://f6f5421d.ngrok.io/superadmin/viewzero').then((adminData0)=>{
            ...
            this.setState({adminObject0: adminData0.data})
                ...
                axios.get('https://f6f5421d.ngrok.io/superadmin/viewone').then((adminData1)=>{
        ...
        handleUpdateStatus1 =(event,rowid)=>{
         ...
         //PUT Request to Modify payment status
          axios.put('https://f6f5421d.ngrok.io/superadmin/updatestatus0to1/'+rowid)
          .then(response => {
        ...
        handleUpdateStatus2 =(event,rowid)=>{
           ...
           //PUT Request to Modify payment status
            axios.put('https://f6f5421d.ngrok.io/superadmin/updatestatus1to0/'+rowid)
            .then(response => {
          ...
          AddAdmin = (event) => {
            ...
            axios.post('https://f6f5421d.ngrok.io/superadmin/addmanual',this.state)
            .then(response => {
