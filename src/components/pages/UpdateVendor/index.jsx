...
class UpdateVendor extends Component{
  ...
  constructor(props) {
   ...
   componentDidMount(){
    ...
    axios.get('https://75aea139.ngrok.io/vendor/view/'+this.props.location.state.Id).then((adminData)=>{
  ...
  mySubmitHandler = (event) => {
    ...
    axios.put('https://5b508783.ngrok.io/vendor/update/'+this.props.location.state.Id,this.state).then(()=> {
            ...
            <Grid.Column>
                         <Form  style={{ width: "50%"}} onSubmit={this.mySubmitHandler} >
                             <div style={{marginLeft:"54%",marginTop:"5%"}}>
                                ...
                                <Form.Select fluid label='Entity Type' clearable options={entitytype} selection placeholder='Entity Type' onChange={this.myChangeHandler1} value={this.state.ventype}/>
